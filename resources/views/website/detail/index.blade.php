...
<div class="images">
    @foreach($product->othetImages as $otherImage )
...
<p class="category"><i class="lni lni-tag"></i> Product category:<a href="javascript:void(0)">
...
<!-- <button href="" class="btn pt-3" style="width: 100%;">Add to Cart</button>{{route('show-cart')}} -->
